...
exports.Cmm2Controller = void 0;
var data_source_1 = require("../data-source");
var Archive_1 = require("../entity/Archive");
var Cmm2Controller = /** @class */ (function () {
    function Cmm2Controller() {
        this.cmm2Repository = data_source_1.cmm2.getRepository(Archive_1.Archive);
    }
    Cmm2Controller.prototype.last = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, data_source_1.cmm2.query("SELECT *, DATE_FORMAT(FROM_UNIXTIME(dateTime), '%Y-%m-%d %H:%i:%s') AS formattedDateTime\n            FROM archive\n            WHERE dateTime = (\n                SELECT MAX(dateTime)\n                FROM archive\n            );")];
                    case 1:
                        results = _a.sent();
    ...
    Cmm2Controller.prototype.Find = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
...
//# sourceMappingURL=Cmm2Controller.js.map